...
| 2026-09-10 | The **logo is a fixed box in the header and the footer** — `150x22`, cropped to fill — so swapping the file in Settings cannot change how big the logo reads. Extends the 2026-09-08 row: the artwork's own colours in the header, still knocked out to white in the footer, which was tried the other way and put back |
